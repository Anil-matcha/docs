...
- **[Hybrid setup](/langsmith/hybrid-legacy)**: For hybrid hosting.
...
- Completed infrastructure setup to enable your [data plane](/langsmith/data-plane) to receive application deployments:
  - [Hybrid setup](/langsmith/hybrid-legacy): Installs data plane components (listener, operator, CRDs) in your Kubernetes cluster that connect to LangChain's managed control plane.
