...
<Tip>
LangSmith offers multiple deployment options beyond Cloud, including [hybrid](/langsmith/hybrid) and [standalone servers](/langsmith/deploy-standalone-server) for self-hosting your Agent Servers. For more information, refer to the [Deployment overview](/langsmith/deployment).
</Tip>
