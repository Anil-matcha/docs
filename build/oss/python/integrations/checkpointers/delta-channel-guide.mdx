...
This guide is for third-party [`BaseCheckpointSaver`](https://reference.langchain.com/python/langgraph/checkpoints/#langgraph.checkpoint.base.BaseCheckpointSaver) authors who need to support graphs using [`DeltaChannel`](https://reference.langchain.com/python/langgraph/channels/delta/DeltaChannel). It covers:
...
- [`InMemorySaver`](https://reference.langchain.com/python/langgraph/checkpoints/#langgraph.checkpoint.memory.InMemorySaver)`.put`—simplest, at `libs/checkpoint/langgraph/checkpoint/memory/__init__.py`
- [`PostgresSaver`](https://reference.langchain.com/python/langgraph/checkpoints/#langgraph.checkpoint.postgres.PostgresSaver)`.put`—sentinel + side-blob, at `libs/checkpoint-postgres/langgraph/checkpoint/postgres/__init__.py`
- [`SqliteSaver`](https://reference.langchain.com/python/langgraph/checkpoints/#langgraph.checkpoint.sqlite.SqliteSaver)`.put`—inline, at `libs/checkpoint-sqlite/langgraph/checkpoint/sqlite/__init__.py`
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/checkpointers/delta-channel-guide.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
