...
<Card title="Support DeltaChannel in custom checkpointers" icon="book" href="/oss/python/integrations/checkpointers/delta-channel-guide">
  Implementing your own `BaseCheckpointSaver`? Read the DeltaChannel guide to handle delta history, snapshots, and cleanup methods correctly.
</Card>
