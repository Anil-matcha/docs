...
<Card
  title="Analyze traces with Chat"
  icon="sparkles"
  href="/langsmith/chat"
  arrow="true"
>
  LangSmith Chat analyzes your traces and surfaces insights about performance, errors, and quality—without manual investigation.
</Card>
